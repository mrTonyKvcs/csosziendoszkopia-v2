...
import { classNames, getConsultationName } from "@/utils";
import Warning from "../Alerts/Warning";

const ConsultationSelector = ({ selected, setSelected, consultations }) => {
    return (
                            ...
                            <div className="relative mt-2">
                                ...
                                >
                                    <Listbox.Options className="absolute z-10 w-full py-1 mt-1 overflow-auto text-base bg-white shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                        {Object.values(consultations)?.map(
                                            (consultation, index) => (
                                                <Listbox.Option
                                                    key={index}
                                                    className={({ active }) =>
